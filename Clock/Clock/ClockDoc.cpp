...
// 缩略图的支持
void CClockDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CClockDoc::InitializeSearchContent()
{
...
void CClockDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
